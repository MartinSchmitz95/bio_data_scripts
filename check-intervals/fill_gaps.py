...
if __name__ == '__main__':
    ...
    parser.add_argument('--folder', type=str, default='../../scratch/winnowmap_real_reads_files/generated_winnowmap_real_reads_SRR', help='Path to folder with fasta files')
